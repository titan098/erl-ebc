...
%%
%% @doc tx_handler is a handler and dispatcher for transactions that have been received by
%% this node. Transactions are received and then advertised to connected peers
%% the connected peers can then request them from this node.
%%
