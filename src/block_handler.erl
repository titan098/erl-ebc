...
%%
%% @doc block_handler is a module that handles block that have been fetched from
%% the bitcoin network. Generic callbacks can be provided and executed when a block arrives
%%
